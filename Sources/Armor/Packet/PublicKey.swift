...
/**
    ...
    + ECDSA
     sep256k1 https://unix.stackexchange.com/questions/589730/gnupg-secp256k1-signature-does-not-match-other-implementations
 https://github.com/kolodny/openpgpjs-secp256k1/search?q=secp256k1
 */
...
public struct PublicKey:Packetable {
    ...
    public func toData() -> Data {
        ...
        // add created time
        // RM: Simplifying the protocol by removing the timestamp
        // All keyID will now always be the deterministic and equatable
//        data.append(contentsOf: UInt32(created.timeIntervalSince1970).fourByteBigEndianBytes())
        data.append(contentsOf: UInt32(0).fourByteBigEndianBytes())
